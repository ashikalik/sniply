...
import { ISniplyQrCodeV1Delete } from '../service/sniply-qr-code-v1-delete.interface';
import { SniplyQrCodeV1Entity } from './sniply-qr-code-v1.entity';

@Injectable()
export class DeleteQrCodeV1PostgresqlService implements ISniplyQrCodeV1Delete {
  constructor(
